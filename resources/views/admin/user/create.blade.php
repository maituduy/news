        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <form method="post" action="{{route('users.store')}}" id="create_form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="sex" value="0">Female
                                </label>
                            </div>
                        </div>
                    </form>
                ...
                <div class="tile-footer">
                    <button class="btn btn-primary" form="create_form" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="{{route('users.index')}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                </div>
            </div>
        </div>
    </div>
